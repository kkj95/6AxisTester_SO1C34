...
namespace FZ4P
{
  ...
  //      [Option("Fixed Center")] public bool FixedCenter { get; set; }
    ...
    //    [Condition("Y", "Code Range", "OIS Y Scan", "", "code")] public int iYCodeRange { get; set; } = 2048;
        ...
        [Condition("OIS SINEWAVE", "Slave_ID_X", "OIS SINEWAVE", "", "code")] public int Slave_ID_X { get; set; } = 0;
        [Condition("OIS SINEWAVE", "Slave_ID_Y", "OIS SINEWAVE", "", "code")] public int Slave_ID_Y { get; set; } = 0;
        [Condition("OIS SINEWAVE", "Slave_ID_Z", "OIS SINEWAVE", "", "code")] public int Slave_ID_Z { get; set; } = 0;
        [Condition("OIS SINEWAVE", "Clock_Devision", "OIS SINEWAVE", "", "--")] public int Clock_Devision { get; set; } = 0;
        [Condition("OIS SINEWAVE", "eOIS_Device_Number", "OIS SINEWAVE", "", "--")] public int eOIS_Device_Number { get; set; } = 0;
